...
export default function ThailandMap({ setRegion, setLengthOfCountriesToFinishGaming  }){
    ...
    useEffect(()=>{
        if(Object.keys(thMill.content.paths).length === 0) return;        
        setLengthOfCountriesToFinishGaming(Object.keys(thMill.content.paths).length)
    },[]);

    return(
        <VectorMap map={thMill} series={{
            regions: [{
                scale: ["#E2AEFF", "#5E32CA"],
