...
export default function OceaniaMap({ setRegion, setLengthOfCountriesToFinishGaming  }){
    ...
    useEffect(()=>{
        if(Object.keys(oceaniaMill.content.paths).length === 0) return;        
        setLengthOfCountriesToFinishGaming(Object.keys(oceaniaMill.content.paths).length)
    },[]);

    return(
        <VectorMap map={oceaniaMill} series={{
            regions: [{
                scale: ["#E2AEFF", "#5E32CA"],
