...
export default function AsiaMap({ setRegion, setLengthOfCountriesToFinishGaming }){
    ...
    useEffect(()=>{
        if(Object.keys(asiaMill.content.paths).length === 0) return;        
        setLengthOfCountriesToFinishGaming(Object.keys(asiaMill.content.paths).length)
    },[]);

    return(
        <VectorMap map={asiaMill} series={{
            regions: [{
                scale: ["#E2AEFF", "#5E32CA"],
