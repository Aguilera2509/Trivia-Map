...
export default function NetherlandsMap({ setRegion, setLengthOfCountriesToFinishGaming  }){
    ...
    useEffect(()=>{
        if(Object.keys(nlMill.content.paths).length === 0) return;        
        setLengthOfCountriesToFinishGaming(Object.keys(nlMill.content.paths).length)
    },[]);

    return(
        <VectorMap map={nlMill} series={{
            regions: [{
                scale: ["#E2AEFF", "#5E32CA"],
