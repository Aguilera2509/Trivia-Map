...
export default function RussiaDistrictsMap({ setRegion, setLengthOfCountriesToFinishGaming  }){
    ...
    useEffect(()=>{
        if(Object.keys(ruFdMill.content.paths).length === 0) return;        
        setLengthOfCountriesToFinishGaming(Object.keys(ruFdMill.content.paths).length)
    },[]);

    return(
        <VectorMap map={ruFdMill} series={{
            regions: [{
                scale: ["#E2AEFF", "#5E32CA"],
